...
<reference>
@/home/user/SavoryMind/slotly/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/SavoryMind/slotly/.claude/get-shit-done/references/user-profiling.md` to load:
