...
Reference full template: `/home/user/SavoryMind/slotly/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/SavoryMind/slotly/.claude/get-shit-done/templates/state.md`.
