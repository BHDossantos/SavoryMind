...
Use template from `/home/user/SavoryMind/slotly/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/SavoryMind/slotly/.claude/get-shit-done/templates/UI-SPEC.md`
