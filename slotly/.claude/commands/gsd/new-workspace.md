...
<execution_context>
@/home/user/SavoryMind/slotly/.claude/get-shit-done/workflows/new-workspace.md
@/home/user/SavoryMind/slotly/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/home/user/SavoryMind/slotly/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
