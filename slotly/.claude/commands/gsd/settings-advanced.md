...
<execution_context>
@/home/user/SavoryMind/slotly/.claude/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@/home/user/SavoryMind/slotly/.claude/get-shit-done/workflows/settings-advanced.md`.
