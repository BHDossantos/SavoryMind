...
<execution_context>
@/home/user/SavoryMind/slotly/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/home/user/SavoryMind/slotly/.claude/get-shit-done/workflows/manager.md end-to-end.
