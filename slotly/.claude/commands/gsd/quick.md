...
<execution_context>
@/home/user/SavoryMind/slotly/.claude/get-shit-done/workflows/quick.md
</execution_context>
...
Execute the quick workflow from @/home/user/SavoryMind/slotly/.claude/get-shit-done/workflows/quick.md end-to-end.
