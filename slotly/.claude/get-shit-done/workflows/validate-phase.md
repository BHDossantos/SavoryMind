...
```
Task(
  prompt="Read /home/user/SavoryMind/slotly/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/SavoryMind/slotly/.claude/get-shit-done/templates/VALIDATION.md`
