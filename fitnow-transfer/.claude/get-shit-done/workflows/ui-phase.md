...
```markdown
Read /home/user/FitNow/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/FitNow/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/FitNow/.claude/agents/gsd-ui-checker.md for instructions.
