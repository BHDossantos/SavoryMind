...
```
Task(
  prompt="Read /home/user/FitNow/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/FitNow/.claude/get-shit-done/templates/SECURITY.md`
