...
<required_reading>
@/home/user/FitNow/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/FitNow/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/FitNow/.claude
                  → checks /home/user/FitNow/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/FitNow/.claude/get-shit-done
                  → writes to /home/user/FitNow/.claude/get-shit-done/hooks/
...
@/home/user/FitNow/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/FitNow/.claude/get-shit-done/references/common-bug-patterns.md
