...
<reference>
@/home/user/FitNow/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/FitNow/.claude/get-shit-done/references/user-profiling.md` to load:
