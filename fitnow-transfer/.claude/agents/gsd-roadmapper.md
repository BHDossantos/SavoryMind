...
Reference full template: `/home/user/FitNow/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/FitNow/.claude/get-shit-done/templates/state.md`.
