...
<execution_context>
@/home/user/FitNow/.claude/get-shit-done/workflows/quick.md
</execution_context>
...
Execute the quick workflow from @/home/user/FitNow/.claude/get-shit-done/workflows/quick.md end-to-end.
