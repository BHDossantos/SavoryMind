...
<execution_context>
@/home/user/FitNow/.claude/get-shit-done/workflows/progress.md
</execution_context>

<process>
Execute the progress workflow from @/home/user/FitNow/.claude/get-shit-done/workflows/progress.md end-to-end.
