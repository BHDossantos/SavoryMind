...
<execution_context>
@/home/user/FitNow/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/home/user/FitNow/.claude/get-shit-done/workflows/manager.md end-to-end.
