...
<execution_context>
@/home/user/FitNow/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/home/user/FitNow/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
