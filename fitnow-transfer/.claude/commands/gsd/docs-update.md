...
<execution_context>
@/home/user/FitNow/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/home/user/FitNow/.claude/get-shit-done/workflows/docs-update.md end-to-end.
