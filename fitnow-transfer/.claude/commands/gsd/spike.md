...
<execution_context>
@/home/user/FitNow/.claude/get-shit-done/workflows/spike.md
...
<process>
Execute the spike workflow from @/home/user/FitNow/.claude/get-shit-done/workflows/spike.md end-to-end.
