...
<execution_context>
@/home/user/FitNow/.claude/get-shit-done/workflows/inbox.md
</execution_context>
...
<process>
Execute the inbox workflow from @/home/user/FitNow/.claude/get-shit-done/workflows/inbox.md end-to-end.
