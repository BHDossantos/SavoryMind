...
Use template from `/home/user/SavoryMind/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/SavoryMind/.claude/get-shit-done/templates/UI-SPEC.md`
