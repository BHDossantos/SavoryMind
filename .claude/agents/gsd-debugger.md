...
<required_reading>
@/home/user/SavoryMind/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/SavoryMind/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/SavoryMind/.claude
                  → checks /home/user/SavoryMind/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/SavoryMind/.claude/get-shit-done
                  → writes to /home/user/SavoryMind/.claude/get-shit-done/hooks/
...
@/home/user/SavoryMind/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/SavoryMind/.claude/get-shit-done/references/common-bug-patterns.md
