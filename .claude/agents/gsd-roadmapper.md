...
Reference full template: `/home/user/SavoryMind/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/SavoryMind/.claude/get-shit-done/templates/state.md`.
