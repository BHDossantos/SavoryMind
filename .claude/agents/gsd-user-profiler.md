...
<reference>
@/home/user/SavoryMind/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/SavoryMind/.claude/get-shit-done/references/user-profiling.md` to load:
