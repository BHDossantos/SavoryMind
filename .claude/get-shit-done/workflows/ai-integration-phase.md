...
<required_reading>
@/home/user/SavoryMind/.claude/get-shit-done/references/ai-frameworks.md
@/home/user/SavoryMind/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/user/SavoryMind/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/user/SavoryMind/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/user/SavoryMind/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/user/SavoryMind/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/user/SavoryMind/.claude/agents/gsd-eval-planner.md for instructions.
