...
Read and follow `/home/user/SavoryMind/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @/home/user/SavoryMind/.claude/get-shit-done/workflows/diagnose-issues.md
