...
```markdown
Read /home/user/SavoryMind/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/SavoryMind/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/SavoryMind/.claude/agents/gsd-ui-checker.md for instructions.
