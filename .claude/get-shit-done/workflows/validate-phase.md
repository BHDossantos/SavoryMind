...
```
Task(
  prompt="Read /home/user/SavoryMind/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/SavoryMind/.claude/get-shit-done/templates/VALIDATION.md`
