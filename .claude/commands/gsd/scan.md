...
<execution_context>
@/home/user/SavoryMind/.claude/get-shit-done/workflows/scan.md
</execution_context>

<process>
Execute the scan workflow from @/home/user/SavoryMind/.claude/get-shit-done/workflows/scan.md end-to-end.
</process>
