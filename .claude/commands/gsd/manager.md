...
<execution_context>
@/home/user/SavoryMind/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/home/user/SavoryMind/.claude/get-shit-done/workflows/manager.md end-to-end.
