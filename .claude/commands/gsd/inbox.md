...
<execution_context>
@/home/user/SavoryMind/.claude/get-shit-done/workflows/inbox.md
</execution_context>
...
<process>
Execute the inbox workflow from @/home/user/SavoryMind/.claude/get-shit-done/workflows/inbox.md end-to-end.
