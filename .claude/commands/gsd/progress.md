...
<execution_context>
@/home/user/SavoryMind/.claude/get-shit-done/workflows/progress.md
</execution_context>

<process>
Execute the progress workflow from @/home/user/SavoryMind/.claude/get-shit-done/workflows/progress.md end-to-end.
