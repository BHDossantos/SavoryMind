...
<execution_context>
@/home/user/SavoryMind/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @/home/user/SavoryMind/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
