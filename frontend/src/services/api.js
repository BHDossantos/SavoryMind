...
export const api = {
  ...
  getMarketingTriggers: () => request("/api/restaurant/marketing/triggers"),
  markMarketingTrigger: (id, status) => request(`/api/restaurant/marketing/triggers/${id}/${status}`, { method: "POST" }),
